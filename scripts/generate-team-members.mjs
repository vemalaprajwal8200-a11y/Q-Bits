...
const DOMAINS_DATA = [
  {
    ...
    members: [
      ...
      { name: 'Janvika Malapati', role: 'Member', code: 'TC-02' },
      { name: 'Prisha Ruturaj C', role: 'Member', code: 'TC-03' },
      { name: 'Vemala Prajwal', role: 'Member', code: 'TC-04' },
      { name: 'Haripriya Katabathina', role: 'Member', code: 'TC-05' },
      { name: 'Hiranmayi', role: 'Member', code: 'TC-06' },
      { name: 'Pranav Rohan', role: 'Member', code: 'TC-07' },
      { name: 'Farhan Akhtar', role: 'Member', code: 'TC-08' },
      { name: 'Jadyn', role: 'Member', code: 'TC-09' },
  ...
  },
  {
    ...
    members: [
      ...
      { name: 'Abhinav Deo', role: 'Member', code: 'AD-04' },
  ...
  },
  {
    ...
    members: [
      ...
      { name: 'Melisha Dsouza', role: 'Member', code: 'DS-03' },
      { name: 'Anupriya Kumari', role: 'Member', code: 'DS-04' },
      { name: 'Swasti Jain', role: 'Member', code: 'DS-05' },
      { name: 'Shanmukhi Vytlaa', role: 'Member', code: 'DS-06' },
      { name: 'Dheshna M', role: 'Member', code: 'DS-07' },
      { name: 'Adhya', role: 'Member', code: 'DS-08' },
      { name: 'Kulsum', role: 'Member', code: 'DS-09' },
  ...
  },
  {
    ...
    members: [
      ...
      { name: 'Anya Miryam Camoens', role: 'Member', code: 'EV-05' },
      { name: 'M Hemanth Reddy', role: 'Member', code: 'EV-06' },
      { name: 'V Jayanth', role: 'Member', code: 'EV-07' },
      { name: 'Raksha Jagadeesha', role: 'Member', code: 'EV-08' },
    ],
  },
  {
    id: 'hospitality',
